...
3. Copy `.env.example` to `.env.local` and set `NEXT_PUBLIC_CAL_BOOKING_URL` to the event's public URL.
4. Add the same environment variable to the deployment and redeploy.
